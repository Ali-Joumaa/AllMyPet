...
import { FaFacebook, FaPinterest, FaTumblr, FaInstagram, FaYoutube, FaPhone, FaEnvelope, FaMapMarkerAlt } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          <h3>Contact Us</h3>
          <p><FaMapMarkerAlt className="icon" /> 123 Main Street, Anytown, USA</p>
          <p><FaPhone className="icon" /> +1 (555) 123-4567</p>
          <p><FaEnvelope className="icon" /> FurryFriendsSupport@gmail.com</p>
        </div>
