  ...
  return (
    <div className="top-home-container">
      <div className="top-home-text">
        ...
        <p>
          Looking for a furry companion? Many adorable pets are waiting for a forever home. 
          Browse through our adoption listings and find the perfect match for your family.
           Adopting a pet not only brings joy to your home but also saves a life.
        </p>
